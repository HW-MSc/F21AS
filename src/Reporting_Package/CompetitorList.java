...
public class CompetitorList {
    ...
    public ArrayList getReport(){
        ...
        ArrayList<CompetitorSubClass> a= new ArrayList();
        
        CompetitorSubClass[] obj = new CompetitorSubClass[100]; 
        ...
        try{
            ...
            BufferedReader br = new BufferedReader(fr);
                ...
                while((f = br.readLine())!=null){
                    ...
                    obj[i] = new CompetitorSubClass();
                    
                    parts = f.split(",");
                    
                    obj[i].cno = Integer.parseInt(parts[0]);
                    obj[i].name = parts[1];
