...
public class Registration extends javax.swing.JFrame {
    ...
    public Registration() {
        ...
        try{
            ...
            FileWriter fw = null;
            try {
                File f = new File("Competitors.txt");
                fw = new FileWriter(f);
                fw.close();
                Cno.setText("100");
    ...
    private void initComponents() {
        ...
        jPanel3.setBackground(new java.awt.Color(142, 229, 238));
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Add Full Infomation", 0, 0, new java.awt.Font("Times New Roman", 1, 14))); // NOI18N
        ...
        Categorie.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Category 1", "Category 2", "Category 3" }));
        ...
        Level.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Master", "Challenger", "Expert", "Rookie" }));
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(Categorie, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jLabel8)
                        .addGap(23, 23, 23))
                    .addComponent(Cno, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel2.setBackground(new java.awt.Color(152, 245, 255));
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitActionPerformed
        ...
        try{
            ...
            if(Name.getText().isEmpty() || Name.getText().charAt(0) == ' '){
                ...
                try {
                    ...
                    FileReader fin;
                        ...
                        fin = new FileReader("Competitors.txt");
                    ...
                    while((f = br.readLine())!=null){
                        ...
                        if(parts[2].equals(Email.getText()) && parts[5].equals(Categorie.getSelectedItem().toString())){
                            chk = 1;
                            break;
                        }
                ...
                if(chk==1){
                    JOptionPane.showMessageDialog(null, "Same category with this Email is already Selected!!");
                }
                            ...
                            FileWriter fout;
                                ...
                                fout = new FileWriter("Competitors.txt",true);


                            fout.write(Cno.getText()+","+Name.getText()+","+Email.getText()+","+Age.getText()+","+Country.getText()+","+Categorie.getSelectedItem().toString()+","+Level.getSelectedItem().toString());
